 ...
 * @author Kelly
 */
public class Problem011_LargestGridProduct {
    public static void main (String[] args) {
        ...
        // split the grid into an array
        String[] numbersLine = numbers.split("\n");
        String[][] numbersGrid = new String[20][20];
        for (int i = 0; i < numbersGrid.length; i++) {
            numbersGrid[i] = numbersLine[i].split(" ");
        }
        ...
        for (int i = 0; i < grid.length; i++) {
            for (int j = 0; j < grid[i].length; j++) {
                grid[i][j] = Integer.parseInt(numbersGrid[i][j]);
            }
        }
